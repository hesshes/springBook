...
public class SpringBook {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		AnnotationConfigApplicationContext countCtx = new AnnotationConfigApplicationContext(CountingDaoFactory.class);

		UserDao countDao = countCtx.getBean("userDao", UserDao.class);
		UserDao countDao2 = countCtx.getBean("userDao", UserDao.class);
		UserDao countDao3 = countCtx.getBean("userDao", UserDao.class);
		UserDao countDao4 = countCtx.getBean("userDao", UserDao.class);

		CountingConnectionMaker ccm = countCtx.getBean("connectionMaker", CountingConnectionMaker.class);
